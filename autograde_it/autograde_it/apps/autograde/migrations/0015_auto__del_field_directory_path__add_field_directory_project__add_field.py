...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Directory.path'
        db.delete_column('autograde_directory', 'path')

        # Adding field 'Directory.project'
        db.add_column('autograde_directory', 'project',
        ...
        # Adding field 'Directory.name'
        db.add_column('autograde_directory', 'name',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Directory.path'
        db.add_column('autograde_directory', 'path',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=1000, unique=True),
                      keep_default=False)

        # Deleting field 'Directory.project'
        db.delete_column('autograde_directory', 'project_id')

        # Deleting field 'Directory.parent'
        db.delete_column('autograde_directory', 'parent_id')

        # Deleting field 'Directory.name'
        db.delete_column('autograde_directory', 'name')
    ...
    models = {
        ...
        'autograde.directory': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['autograde.Directory']", 'null': 'True'}),
